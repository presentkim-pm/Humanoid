...
namespace blugin\humanoid;

use pocketmine\entity\Entity;
use pocketmine\plugin\PluginBase;
use blugin\humanoid\command\PoolCommand;
use blugin\humanoid\command\subcommands\{
...
use blugin\humanoid\entity\Humanoid as HumanoidEntity;
use blugin\humanoid\listener\DataPacketEventListener;
use blugin\humanoid\listener\PlayerEventListener;
